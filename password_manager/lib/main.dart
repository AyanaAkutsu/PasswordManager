  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/view': (BuildContext context) => ViewScreenState(title: '',),
        '/list':(BuildContext context) => ListScreen(title: 'サービス一覧'),
        '/userList':(BuildContext context) => UserListScreen(title: 'ユーザ一覧'),
        '/adminTop':(BuildContext context) => AdminScreen(title: '管理者用トップ画面'),
